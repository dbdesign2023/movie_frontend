...
function RatingAddForm() {
  ...
  return (
    <div className="modal-container">
      ...
      <div className="form-container" onSubmit={handleSubit(onSubmit)}>
      ...
      <div className="form-container">
        <div className="row">
          ...
          <div class="col-4">
            <div className="inner-form-container">
              ...
              <button type="button" class="btn btn-outline-secondary" onClick={showRatingModal}>
                수정
              </button>
              <Modal visible={ratingModalOpen} effect="fadeInDown" onClickAway={closeRatingModal}>
                <RatingAddForm />
              </Modal>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-4">
            ...
            <div className="content-text-container"></div>
            <button type="button" class="btn btn-outline-secondary" onClick={showGenreModal}>
              수정
            </button>
            <Modal visible={genreModalOpen} effect="fadeInDown" onClickAway={closeGenreModal}>
              <div className="modal-container">
                ...
                <div className="form-container">
                  ...
                  <div className="bottom-container">
                    <div className="button-container">
                      <button type="button" class="btn btn-secondary" onClick={closeGenreModal}>
                        닫기
                      </button>
                    </div>
                  </div>
        ...
        <div className="row">
          ...
          <div class="col-4">
            ...
            <div className="content-text-container"></div>
            <button type="button" class="btn btn-outline-secondary" onClick={showOfficialModal}>
              추가
            </button>
            <Modal visible={officialModalOpen} effect="fadeInDown" onClickAway={closeOfficialModal}>
              <div className="modal-container">
                ...
                <div className="form-container">
                  ...
                  <div className="bottom-container">
                    ...
                    <div className="button-container">
                      <button type="button" class="btn btn-outline-success  " onClick={setOfficialReset}>
                        초기화
                      </button>
                    </div>
                    <div className="button-container">
