    ...
    const data = [
            {
                ...
                poster_url: "https://talkimg.imbc.com/TVianUpload/tvian/TViews/image/2023/05/08/0124c55a-d9fe-40a9-8cd1-e3c8085ca69c.jpg",
                contry:"USA",
                language:"영어",
                director:"제임스 건",
                rating:"https://i.namu.wiki/i/_gPC-Ku_ZOFffvjZuH-As657jDePOv8nyqosVQO4vQIOcAxFSYWg5kl2TtVeoB1NShzPxfFS9WATxAP6Qh8kvlTL7szEqCWBYeQFdX2zH8F7X0MOJWu_N1yGgwnzBrzrcBo6Hf-1vim5-T3j8vON5w.svg"
            },
            {
                movie_id: 2,
                title: "아바타 물의 길",
                ...
                poster_url: "https://cdn.ngetnews.com/news/photo/202211/412751_34579_559.jpg",
                contry:"USA",
                language:"영어",
                director:"제임스 카메론",
                rating:"https://i.namu.wiki/i/_gPC-Ku_ZOFffvjZuH-As657jDePOv8nyqosVQO4vQIOcAxFSYWg5kl2TtVeoB1NShzPxfFS9WATxAP6Qh8kvlTL7szEqCWBYeQFdX2zH8F7X0MOJWu_N1yGgwnzBrzrcBo6Hf-1vim5-T3j8vON5w.svg"
                ...
                <div className='row'>
                    {data.map((item)=>(
                        <div key={item.movie_id} className="w-25">
                                    ...
                                    <div className='modal-container'>
                                        ...
                                        <div className='form-container'>
                                            <div className='row'>
                                                ...
                                                <div className='w-50'>
                                                    <img src={item.rating} className='w-25'>
                                                    </img>
                                                    <div>
                                                        12세 이용가
                                                    </div>
                            ...
                            <button key={item.movie_id} className="btn btn-white" onClick={clickHandler.bind(item)}>
                                <img src={item.poster_url} className="w-100"/>
                                <h4>{item.title}</h4>
                            </button>
                        </div>
